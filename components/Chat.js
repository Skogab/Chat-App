...
const Chat = ({ isConnected, db, route, navigation, storage }) => {
	...
	// Declare variable to hold the messages unsubscribe function
	let unsubMessages;

	// Set up an effect that runs when the component mounts or isConnected changes
	useEffect(() => {
	...
	// Input Bar showing when connetced, if offline not
